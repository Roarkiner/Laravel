...
@section('script')
    ...
    <script src="assets/js/modify_book_form.js" type="text/javascript" defer></script>
@endsection
...
@section('content')
    ...
    <form action="/modify_book" method="post">
        ...
        <div>
            ...
            <select @error('author_id') {{ 'class=input_error' }} @enderror name="author_id" id="author" data-value="{{ $book->author->id }}" required>
        ...
        <div>
            ...
            <select @error('genre') {{ 'class=input_error' }} @enderror name="genre" id="genre" data-value="{{ $book->genre }}" required>
